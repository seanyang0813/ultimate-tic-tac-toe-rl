...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--step-per-collect", type=int, default=90)
...
def get_agents(
    ...
    print(args.state_shape, args.action_shape, args.hidden_sizes, args.lr, args.n_step, args.gamma, args.target_update_freq)
